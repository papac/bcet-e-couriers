...
%block('title', 'Modifier colis - BCET e-Couriers')
                    ...
                    <div class="bg-white shadow rounded-xl">
                        ...
                        <div class="p-6 space-y-4">
                            <div>
                                ...
                                <input type="text" name="sender_name" id="sender_name" required value="{{ $courier->sender_name }}"
                            ...
                            <div>
                                ...
                                <input type="tel" name="sender_phone" id="sender_phone" required value="{{ $courier->sender_phone }}"
                                    class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                            </div>
                            <div>
                                ...
                                <textarea name="sender_address" id="sender_address" rows="3" required
                                    class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">{{ $courier->sender_address }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white shadow rounded-xl">
                        ...
                        <div class="p-6 space-y-4">
                            <div>
                                ...
                                <input type="text" name="receiver_name" id="receiver_name" required value="{{ $courier->receiver_name }}"
                                    class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                            </div>
                            <div>
                                <label for="receiver_phone" class="block text-sm font-medium text-gray-700 mb-1">Téléphone *</label>
                                <input type="tel" name="receiver_phone" id="receiver_phone" required value="{{ $courier->receiver_phone }}"
                                    class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                            </div>
                            <div>
                                ...
                                <textarea name="receiver_address" id="receiver_address" rows="3" required
                                    class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">{{ $courier->receiver_address }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="text" name="description" id="description" value="{{ $courier->description }}"
                                    class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                            </div>
                            <div>
                                <label for="weight" class="block text-sm font-medium text-gray-700 mb-1">Poids (kg)</label>
                                <input type="number" name="weight" id="weight" step="0.1" min="0" value="{{ $courier->weight }}"
                                    class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                            </div>
                            <div>
                                <label for="price" class="block text-sm font-medium text-gray-700 mb-1">Prix (FCFA)</label>
                                <input type="number" name="price" id="price" step="100" min="0" value="{{ $courier->price }}"
                                    class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                            </div>
                        </div>
                        <div class="mt-4">
                            ...
                            <textarea name="notes" id="notes" rows="2"
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">{{ $courier->notes }}</textarea>
                        </div>
                    </div>
                </div>
