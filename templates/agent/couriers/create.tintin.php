...
%block('title', 'Nouveau colis - BCET/COURIERS')
...
<div x-data="{ sidebarOpen: false }" class="min-h-screen bg-gray-100">
    ...
    <div class="lg:pl-64 flex flex-col flex-1">
        ...
        <main class="flex-1 p-6">
            ...
            <form action="{{ route('couriers.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6" x-data="courierForm()">
                {{ csrf_field() }}
                ...
                <div class="flex items-center justify-end space-x-4">
                    <a href="{{ route('couriers.index') }}" class="px-6 py-2.5 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50">
                        Annuler
                    </a>
